...
TAVILY_AI_API_KEY = os.getenv('TAVILY_AI_API_KEY')
...
async def main():
    ...
    print("Welcome to the Citation Query Chatbot! Type 'exit' to quit.")
    while True:
        query = input("You: ")
        if query.lower() == 'exit':
            print("Goodbye!")
        ...
        # Optionally, print the first source node for more context
        if result.source_nodes:
            print(f"Source: {result.source_nodes[0].node.get_text()}")
